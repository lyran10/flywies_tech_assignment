...
const displayHeader = () => {
  let headers = ["Questions", "Answers", "Operations"]
  return(
      headers.map((item) => {
          return(
          ...
          return (
              <tr key={index} className={`border-b border-slate-300`}>
                 <td className="text-left p-2">
                  ...
                  <td className="text-left p-2">{item.question}</td>
                  <td className="text-left p-2 w-[50%]">{item.answer}</td>
